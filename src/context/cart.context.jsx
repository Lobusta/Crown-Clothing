...
export const CartProvider = ({children}) => {
    ...
    const [{cartItems, isCartOpen, cartCounter, cartTotal}, dispatch] = useReducer(cartReducer, INITIAL_STATE);
    ...
    const updateCartItemReducer = (newCartItems) => {
        ...
        dispatch(
            createAction(CART_ACTION_TYPE.SET_CART_ITEMS ,{ cartItems: newCartItems, cartTotal: newCartTotal, cartCounter: newCartCount })
        );
